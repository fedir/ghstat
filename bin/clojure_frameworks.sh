echo "## Clojure frameworks statistics rating"
echo ""
...
echo "[Detailed Clojure frameworks statistics with ratings](https://github.com/fedir/ghstat/blob/master/stats/clojure_frameworks.csv)"
echo ""