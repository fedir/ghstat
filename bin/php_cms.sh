#./ghstat -r TYPO3/TYPO3.CMS,Victoire/victoire,backbee/backbee-php,bolt/bolt,concrete5/concrete5,contao/core,drupal/drupal,ezsystems/ezplatform,\
...
#symfony-cmf/symfony-cmf,zikula/core -f stats/php_cms.csv
...
symfony-cmf/symfony-cmf,zikula/core,TYPO3/TYPO3.CMS,drupal/drupal -f stats/php_cms.csv
